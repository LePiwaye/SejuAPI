...
class LeagueItemDTO extends GenericDTO
{
    ...
    protected $hotStreak;
     ...
     /**
     * @var \RiotPHP\DTO\Riot\MiniSeriesDTO Possible miniSeries data (can be null)
     */
     ...
     * @return \RiotPHP\DTO\Riot\MiniSeriesDTO MiniSeries data
     * @author Piwaye
     * @since 1.0
     * @version 1.0
     */
     ...
     * @param $miniSeries \RiotPHP\DTO\Riot\MiniSeriesDTO MiniSeries data
     * @author Piwaye
     * @since 1.0
     * @version 1.0
     */
