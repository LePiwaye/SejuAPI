...
class MatchDTO extends GenericDTO
{
    ...
    /**
     * @var array(\RiotPHP\DTO\Riot\ParticipantIdentityDto) Game ID
     */
    ...
    /**
     * @var array(\RiotPHP\DTO\Riot\TeamStatsDTO) Teams
     */
    protected $teams;

    /**
     * @var array(\RiotPHP\DTO\Riot\ParticipantDTO) Teams
     */
	...
	/**
	 * Get game ID
	 * @return array(\RiotPHP\DTO\Riot\ParticipantIdentityDto) Game ID
     * @author Piwaye
     * @since 1.0
     * @version 1.0
	 */
	...
	/**
	 * Set game ID
	 * @param array(\RiotPHP\DTO\Riot\ParticipantIdentityDto) $participantIdentities Game ID
	 * @author Piwaye
     * @since 1.0
     * @version 1.0
	 */
	...
	/**
	 * Get teams
	 * @return array(\RiotPHP\DTO\Riot\TeamStatsDTO) Teams
     * @author Piwaye
     * @since 1.0
     * @version 1.0
	 */
	...
	/**
	 * Set teams
	 * @param array(\RiotPHP\DTO\Riot\TeamStatsDTO) $teams Teams
	 * @author Piwaye
     * @since 1.0
     * @version 1.0
	 */
	...
	/**
	 * Get teams
	 * @return array(\RiotPHP\DTO\Riot\ParticipantDTO) Teams
     * @author Piwaye
     * @since 1.0
     * @version 1.0
	 */
	...
	/**
	 * Set teams
	 * @param array(\RiotPHP\DTO\Riot\ParticipantDTO) $participants Teams
	 * @author Piwaye
     * @since 1.0
     * @version 1.0
	 */
