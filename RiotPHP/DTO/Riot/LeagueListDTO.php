...
class LeagueListDTO extends GenericDTO
{
    ...
    /**
     * @var array(\RiotPHP\DTO\Riot\LeagueItemDTO) League entries
     */
    protected $entries;  
    ...
    /**
     * Gets entries
     * @return array(\RiotPHP\DTO\Riot\LeagueItemDTO) League entries
     * @author Piwaye
     * @since 1.0
     * @version 1.0
     */
    public function getEntries()
    {
     ...
     /**
     * Sets entries
     * @param $entries array(\RiotPHP\DTO\Riot\LeagueItemDTO) League entries
     * @author Piwaye
     * @since 1.0
     * @version 1.0
     */
