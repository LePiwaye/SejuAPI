...
class ChampionMasteryEndpoint extends GenericEndpoint
{
     ...
     * @since 1.0
     * @version 1.0
     * @return array(\RiotPHP\DTO\ChampionMasteryDTO) Data object
    ...
    public function getChampionMasteriesBySummonerID($encryptedSummonerID){
        ...
        if(is_array($response)){
            ...
            for($iterableResponse = 0; $iterableResponse < count($response); $iterableResponse++){
                $partialResponseDTO = new \RiotPHP\DTO\ChampionMasteryDTO();
     ...
     * @since 1.0
     * @version 1.0
     * @return \RiotPHP\DTO\ChampionMasteryDTO Data object
     * @throws \RiotPHP\Exceptions\BadJSONDataException
     * @throws \RiotPHP\Exceptions\UnsupportedAPICall
     */
    public function getChampionMasteryBySummonerIDByChampionID($encryptedSummonerID, $championID){
        ...
        $response = $this->callManager->sendQuery(\RiotPHP\Collections\QueryHeader::GET, $query);
        if(is_array($response)){
            $responseDTO = new \RiotPHP\DTO\ChampionMasteryDTO();
