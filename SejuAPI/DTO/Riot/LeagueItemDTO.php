...
/**
 * Class LeagueItemDTO
 * This class handles a summoner status in a ranked ladder, used in the League API
 * It's defined accordingly to the LeagueItem declaration on Riot API Reference website
 * @package SejuAPI
 * @author Piwaye
 * @since 1.0
 * @version 1.0
 */
class LeagueItemDTO extends GenericDTO
{
    /**
    ...
    protected $hotStreak;
     ...
     /**
     * @var \SejuAPI\DTO\Riot\MiniSeriesDTO Possible miniSeries data (can be null)
     */
     ...
     * @return \SejuAPI\DTO\Riot\MiniSeriesDTO MiniSeries data
     * @author Piwaye
     * @since 1.0
     * @version 1.0
     */
     ...
     * @param $miniSeries \SejuAPI\DTO\Riot\MiniSeriesDTO MiniSeries data
     * @author Piwaye
     * @since 1.0
     * @version 1.0
     */
