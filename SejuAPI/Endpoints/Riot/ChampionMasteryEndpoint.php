...
class ChampionMasteryEndpoint extends GenericEndpoint
{
    public function __construct(){
        parent::__construct();
        $this->endpointName = \SejuAPI\Collections\Riot\EndpointDescriptor::CHAMPION_MASTERY;
    }
     ...
     * @since 1.0
     * @version 1.0
     * @return array(\SejuAPI\DTO\Riot\ChampionMasteryDTO) Data object
     ...
     * @since 1.0
     * @version 1.0
     * @return \SejuAPI\DTO\Riot\ChampionMasteryDTO Data object
     * @throws \SejuAPI\Exceptions\Riot\UnsupportedAPICall
     */
    public function getChampionMasteryBySummonerIDByChampionID($encryptedSummonerID, $championID){
        ...
        $response = $this->callManager->sendQuery($this->endpointName, $this->serviceRegion, \SejuAPI\Collections\Riot\QueryHeader::GET, $query);
        if(is_array($response)){
            $responseDTO = new \SejuAPI\DTO\Riot\ChampionMasteryDTO();
    ...
    public function getChampionScoreBySummonerID($encryptedSummonerID){
        ...
        return $this->callManager->sendQuery($this->endpointName, $this->serviceRegion, \SejuAPI\Collections\Riot\QueryHeader::GET, $query);
    }
}